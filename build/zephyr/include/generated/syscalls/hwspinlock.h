...
#define hwspinlock_trylock(dev, id) ({ 	int retval; 	sys_port_trace_syscall_enter(K_SYSCALL_HWSPINLOCK_TRYLOCK, hwspinlock_trylock, dev, id); 	retval = hwspinlock_trylock(dev, id); 	sys_port_trace_syscall_exit(K_SYSCALL_HWSPINLOCK_TRYLOCK, hwspinlock_trylock, dev, id, retval); 	retval; })
#endif
#endif
...
#define hwspinlock_get_max_id(dev) ({ 	uint32_t retval; 	sys_port_trace_syscall_enter(K_SYSCALL_HWSPINLOCK_GET_MAX_ID, hwspinlock_get_max_id, dev); 	retval = hwspinlock_get_max_id(dev); 	sys_port_trace_syscall_exit(K_SYSCALL_HWSPINLOCK_GET_MAX_ID, hwspinlock_get_max_id, dev, retval); 	retval; })
#endif
#endif
